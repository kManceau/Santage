...
<body>
    <div class="content-overlay">
        <section class="blokken">
            <h1 class="welcome-title">Bienvenue sur la Liste de Vœux du Père Noël !</h1>
            ...
            <p class="welcome-text final-message">
    ...
    <div class="row card-main">
        ...
        <div class="card">
            ...
            @endif
            @if($gift->good)
            <div class="card__content" style="background-color: green; color: white;">
            ...
            @else
            <div class="card__content" style="background-color:red; color: white;">
                <div class="card__content-inner">
                    <div class="card__title">{{ $gift->name }}</div>
